...
export default async function TiersPage() {
  ...
  return <PageShell active="tiers">
    <header className="page-intro"><div><span className="eyebrow">PLAYER POWER RANKING</span><h1>선수 티어표</h1></div><p>1~5티어와 코치로 구분하며, 같은 티어에서는 누적 승률이 높은 선수가 앞에 배치됩니다.</p></header>
    ...
    <AdminOnly><div className="tier-drag-guide"><strong>관리자 편집 모드</strong><span>먼저 선수를 드래그해 배치한 뒤, 상단의 변경사항 저장을 눌러 한 번에 반영하세요.</span></div></AdminOnly>
