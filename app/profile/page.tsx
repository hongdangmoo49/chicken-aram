...
import { TelegramAppLink } from "./telegram-app-link";
  ...
  return <PageShell active="profile">
    ...
    {profile ? <section className="profile-card panel">
      ...
      <div className="profile-forms">
        ...
        <div className="telegram-link"><div><strong>텔레그램 앱 간편 연동</strong><p>{telegram ? `${telegram.username ? `@${telegram.username}` : "텔레그램 계정"}과 연동되었습니다. 다른 계정으로 다시 연동하거나 치증 계정에서 연결을 해제할 수 있습니다.` : "Telegram 앱에서 치증봇을 열어 현재 계정에 투표를 연결합니다."}</p></div><TelegramAppLink linked={Boolean(telegram)} /></div>
